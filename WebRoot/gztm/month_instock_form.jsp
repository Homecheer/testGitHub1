...
<body onload="displayDate()">
	...
	<table width="100%" border="0" align="center" cellspacing="1" class="c" id="detialTab">
		<tr>
			<td class="title1" >入库单据数：<span id="ci"></span></td>
			<td class="title1" >产品总数量：<span id="num"></span></td>
			<td class="title1"  colspan="4">入库产品总金额：<span id="price"></span></td>
	...
	<!-- <form action="Month_Instock_Form" method="get"> -->
